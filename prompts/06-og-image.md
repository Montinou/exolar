...
- **Background**: Gradient from #050508 to #12121A
- **Format**: PNG
- **Style**: Cinematic, epic, 3D render style
...
Lens flares are anamorphic (horizontal blue streaks), adding a sci-fi film aesthetic.
Epic, premium, "Interstellar" movie poster vibes.
```

## Style Notes
- **Drama**: This is the one place we can go "full Hollywood."
- **Scale**: The logo should feel huge, like a space station or a monument.
- **Lighting**: Volumetric lighting is key here.

## Consistency Reference
The "Movie Poster" version of the brand.
